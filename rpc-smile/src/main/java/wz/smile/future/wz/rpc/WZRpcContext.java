 ...
 */
package wz.smile.future.wz.rpc;
...
public class WZRpcContext {

    private static final ThreadLocal<WZRpcContext> LOCAL = new ThreadLocal() {
        @Override
        protected WZRpcContext initialValue() {
            return new WZRpcContext();
        }
    };
     ...
     * @return context
     */
    public WZRpcContext setLocalAddress(String host, int port) {
        if (port < 0) {
            port = 0;
        }
     ...
     * @return context
     */
    public WZRpcContext setLocalAddress(InetSocketAddress address) {
     ...
     * @return context
     */
    public WZRpcContext setRemoteAddress(String host, int port) {
        if (port < 0) {
            port = 0;
        }
     ...
     * @return context
     */
    public WZRpcContext setRemoteAddress(InetSocketAddress address) {
     ...
     * @return context
     */
    public WZRpcContext setAttachment(String key, String value) {
        if (value == null) {
     ...
     * @return context
     */
    public WZRpcContext removeAttachment(String key) {
        attachments.remove(key);
        return this;
    }
     ...
     * @return context
     */
    public WZRpcContext setAttachments(Map<String, String> attachment) {
     ...
     * @return context
     */
    public WZRpcContext set(String key, Object value) {
        if (value == null) {
            values.remove(key);
        } else {
     ...
     * @return value
     */
    public WZRpcContext remove(String key) {
        values.remove(key);
        return this;
    }
    ...
    public WZRpcContext setInvokers(List<Invoker<?>> invokers) {
    ...
    public WZRpcContext setInvoker(Invoker<?> invoker) {
    ...
    public WZRpcContext setInvocation(Invocation invocation) {
