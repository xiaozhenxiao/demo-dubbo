...
public class BuilderProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        elementsAnnotatedWith.forEach(element -> {
            ...
            System.out.println("++++++++++++" + elementTypeMirror);
            ...
            try {
                JavaFile.builder("com.wz.annotation", typeSpec).build().writeTo(System.out);
                JavaFile.builder("com.wz.annotation", typeSpec).build().writeTo(filer);
            } catch (IOException e) {
                e.printStackTrace();
            }
        });
